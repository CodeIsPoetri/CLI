...
exports.login = async function (username, password) {
    const { access_token: accessToken, refresh_token } = await processRequest('/auth/token', 'post', undefined, undefined, {
        form: {
            grant_type: 'password',
            client_id: clientId,
    ...
    Token.set(username, accessToken, refresToken);
};
